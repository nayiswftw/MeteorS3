...
// ================================================================
//  Runtime User Configuration (Saved in NVS Preferences)
// ================================================================
...
struct RuntimeConfig {
    ...
    double latitude       = 30.000000;
    double longitude      = 75.000000;
    char   locationName[32] = "HOME";
    char   timezone[32]     = "Asia/Kolkata";

    TempUnit  tempUnit  = TempUnit::CELSIUS;
    WindUnit  windUnit  = WindUnit::KMH;
    PressUnit pressUnit = PressUnit::HPA;

    uint8_t  backlightBrightness = 220;    // 0 - 255
    uint32_t screenTimeoutSec    = 60;     // 0 = never sleep
    bool     enableGestures      = true;   // IMU tilt & shake
    uint8_t  gestureSensitivity  = 5;      // 1 (low) to 10 (high)
    bool     enableAutoPage      = false;
    uint32_t autoPageSec         = 30;
    ...
    char     mqttTopicPrefix[32] = "weatherstation";
};
